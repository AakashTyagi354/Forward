...
import { data_all_gas } from './InputDataGas';
import { LineChart, CartesianGrid, XAxis, YAxis, Tooltip, Legend, Line } from "recharts"
import { NavLink } from 'react-router-dom';



let week = data_all_gas.slice(6294, 6301);
let month = data_all_gas.slice(6271, 6301);
let sixMonth = data_all_gas.slice(6121, 6301);
let year = data_all_gas.slice(6030, 6301);
let fiveYear = data_all_gas.slice(6000, 6301);
        ...
        <div>
            <div className="inputTop">
                ...
                <NavLink to="/inputgas" className="links">
                    ...
                    <NavLink to="/gasmatrix" className="links">
